...
2026-Q4  2.1  可靠性基础（校验和、限速、条件请求、配置文件）
2027-Q1  2.2  Hook 与事件流（核心大版本）
2027-Q2  2.3  多任务编排（队列、并发上限、依赖）
2027-Q3  2.4  可观测性与生产就绪（metrics、OTel、访问日志）
2027-Q4  3.0  里程碑：trait 抽象 + 流式架构 + 1.0 质量库
```
